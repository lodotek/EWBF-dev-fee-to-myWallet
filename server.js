 ...
 */
var net = require("net");
var yourPoolAddres = 'us.zclmine.pro';
var yourPoolPort = 9009;
var yourWalletID = 't1gNgjyXXEhNPfYXL2uiwKQDUJ2ah2gErDG'; // replace your wallet ID
var yourWorkerName = 'devfee';
var yourWalletPassword = 'x'; // replace your wallet password
var remotePoolAdress = '104.238.147.127'; // replace pool IP address
var remotePoolPort = 9009;
var allShares = 0;
var devShares = 0;
...
console.log("redirecting connections from 127.0.0.1:3333/6666/8088/8008/9009 to %s:%d", remotePoolAdress, remotePoolPort);
